...
- 您可以参阅本文在 developerWorks 全球站点上的 [英文原文](http://www.ibm.com/developerworks/java/library/j-jtp06197.html?S_TACT=105AGX52&S_CMP=cn-a-j) 。
- [*Java Concurrency in Practice*](http://www.amazon.com/exec/obidos/ASIN/0321349601/ref=nosim/none0b69)：使用 Java 代码开发并发程序的 how-to 手册，内容包括构建并编写线程安全的类和程序、避免性能影响、管理性能和测试并发应用程序。
- [流行的原子](http://www.ibm.com/developerworks/cn/java/j-jtp11234/)：介绍了 Java 5.0 中新增的原子变量类，该特性对 volatile 变量进行了扩展，从而支持原子状态转换。
- [非阻塞算法简介](http://www.ibm.com/developerworks/cn/java/j-jtp04186/)：介绍如何使用原子变量而不是锁实现并发算法。
- [Volatiles](http://en.wikipedia.org/wiki/Volatile_variable)：从 Wikipedia 获得关于 volatile 变量的更多信息。
- [Java 技术专区](http://www.ibm.com/developerworks/cn/java/)：提供了数百篇有关 Java 编程各个方面的文章。